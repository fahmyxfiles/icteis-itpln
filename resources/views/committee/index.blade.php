                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <div class="float-end">
                                            <a href="{{ route('committees.create') }}" class="btn btn-primary btn-sm float-end"  data-placement="left">
                                            {{ __('Create New') }}
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
										...
										<th>Name</th>
											...
											<td>{{ $committee->committee_division->name }}</td>
											<td>{{ $committee->name }}</td>

                                                        <td>
                                                            <form action="{{ route('committees.destroy',$committee->id) }}" method="POST" onsubmit="return confirmDelete(this);">
