                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <div class="float-end">
                                            <a href="{{ route('documents.create') }}" class="btn btn-primary btn-sm float-end"  data-placement="left">
                                            {{ __('Create New') }}
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
										...
										<th>Filesize</th>
											...
											<td>{{ $document->name }}</td>
                                            <td>{{ strtoupper($document->published) }}</td>
											<td>{{ basename($document->file_path) }}</td>
											<td>{{ Storage::disk('public')->size($document->file_path) }} bytes</td>

                                                        <td>
                                                            <form action="{{ route('documents.destroy',$document->id) }}" method="POST" onsubmit="return confirmDelete(this);">
