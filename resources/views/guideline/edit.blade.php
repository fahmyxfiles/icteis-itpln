                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <span class="card-title">Update Guideline</span>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="{{ route('guidelines.update', $guideline->id) }}"  role="form" enctype="multipart/form-data" onsubmit="onSubmit();">
                                        {{ method_field('PATCH') }}
                                        @csrf

                                        @include('guideline.form')
