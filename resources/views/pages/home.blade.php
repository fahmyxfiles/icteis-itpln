            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-title white">
                        ...
                        <p>Our speakers who will bring knowledge at ICTEIS 2022</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-title black">
                        <h3>Reviewers</h3>
                        <p>Our jury will judge the papers at IECTIS 2022</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h3><span class="alternate">Partnership</span></h3>
                        <p>Our Partners that always has a bright idea to support ICTEIS 2022</p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="map">
        ...
        <div class="address-block">
            ...
            <ul class="address-list p-0 m-0">
                <li><i class="fa fa-home"></i><span>Menara PLN, Jl. Lkr. Luar Barat, West Jakarta <br>Jakarta Capital City, Indonesia.</span></li>
                <li><i class="fa fa-phone"></i><span>[62] 21 5440342</span></li>
            </ul>
            <a href="https://goo.gl/maps/nZjxuLzncFonuAbA8" target="_blank" class="btn btn-white-md">Get Direction</a>
        </div>
    </section>
