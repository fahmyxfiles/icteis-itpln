    ...
    <div class="sticky">
        <div class="jumper-container">
            <ul class="jumper-tab-list">
                <a class="active-jumper jumper">About</a>
                <a class="jumper">Speakers</a>
                <a class="jumper">Reviewers</a>
                <a class="jumper">Partnership</a>
            </ul>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="{{ asset('images/speakers/speaker-one.jpg') }}" alt="speaker"
                                class="img-fluid">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="{{ asset('images/speakers/speaker-two.jpg') }}" alt="speaker"
                                class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="{{ asset('images/speakers/speaker-three.jpg') }}" alt="speaker"
                                class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="{{ asset('images/speakers/speaker-four.jpg') }}" alt="speaker"
                                class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="{{ asset('images/speakers/speaker-five.jpg') }}" alt="speaker"
                                class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="{{ asset('images/speakers/speaker-six.jpg') }}" alt="speaker"
                                class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                                ...
                                <ul class="m-0 p-0">
                                    ...
                                    <li class="schedule-details">
                                        <div class="block">
                                            ...
                                            <!-- Speaker -->
                                            <div class="speaker">
                                                <img src="{{ asset('images/speakers/speaker-thumb-one.jpg') }}"
                                    ...
                                    <li class="schedule-details">
                                        <div class="block">
                                            ...
                                            <!-- Speaker -->
                                            <div class="speaker">
                                                <img src="{{ asset('images/speakers/speaker-thumb-two.jpg') }}"
                                    ...
                                    <li class="schedule-details">
                                        <div class="block">
                                            ...
                                            <!-- Speaker -->
                                            <div class="speaker">
                                                <img src="{{ asset('images/speakers/speaker-thumb-three.jpg') }}"
                                    ...
                                    <li class="schedule-details">
                                        <div class="block">
                                            ...
                                            <!-- Speaker -->
                                            <div class="speaker">
                                                <img src="{{ asset('images/speakers/speaker-thumb-four.jpg') }}"
                                    ...
                                    <li class="schedule-details">
                                        <div class="block">
                                            ...
                                            <!-- Speaker -->
                                            <div class="speaker">
                                                <img src="{{ asset('images/speakers/speaker-thumb-five.jpg') }}"
                                    ...
                                    <li class="schedule-details">
                                        <div class="block">
                                            ...
                                            <!-- Speaker -->
                                            <div class="speaker">
                                                <img src="{{ asset('images/speakers/speaker-thumb-six.jpg') }}"
                        ...
                        <ul class="list-inline sponsors-list">
                            <li class="list-inline-item">
                                <div class="image-block text-center">
                                    <a href="#">
                                        <img src="{{ asset('images/sponsors/pt-spon-two.png') }}" alt="sponsors-logo"
                                            class="img-fluid">
                                    </a>
                                </div>
                            </li>
                            ...
                            <li class="list-inline-item">
                                <div class="image-block text-center">
                                    <a href="#">
                                        <img src="{{ asset('images/sponsors/pt-spon-three.png') }}"
                                            alt="sponsors-logo" class="img-fluid">
                                    </a>
                                </div>
                            </li>
                            <li class="list-inline-item">
                                <div class="image-block text-center">
                                    <a href="#">
                                        <img src="{{ asset('images/sponsors/pt-spon-four.png') }}"
                                            alt="sponsors-logo" class="img-fluid">
                                    </a>
                                </div>
                            </li>
                    ...
                    <div class="block text-center">
                        ...
                        <ul class="list-inline sponsors-list">
                            <li class="list-inline-item">
                                <div class="image-block text-center">
                                    <a href="#">
                                        <img src="{{ asset('images/sponsors/gl-spon-one.png') }}" alt="sponsors-logo"
                                            class="img-fluid">
                                    </a>
                                </div>
                            </li>
                            <li class="list-inline-item">
                                <div class="image-block text-center">
                                    <a href="#">
                                        <img src="{{ asset('images/sponsors/gl-spon-two.png') }}" alt="sponsors-logo"
                                            class="img-fluid">
                                    </a>
                                </div>
                            </li>
                            <li class="list-inline-item">
                                <div class="image-block text-center">
                                    <a href="#">
                                        <img src="{{ asset('images/sponsors/gl-spon-three.png') }}"
                                            alt="sponsors-logo" class="img-fluid">
                                    </a>
                                </div>
                            </li>
            ...
            <div class="row">
                    ...
                    <div class="blog-post">
                        <div class="post-thumb">
                            <a href="news-single.html">
                                <img src="{{ asset('images/news/post-thumb-one.jpg') }}" alt="post-image"
                                    class="img-fluid">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 col-10 m-auto">
                    <div class="blog-post">
                        <div class="post-thumb">
                            <a href="news-single.html">
                                <img src="{{ asset('images/news/post-thumb-two.jpg') }}" alt="post-image"
                                    class="img-fluid">
                            </a>
                        </div>
                        <div class="post-content">
                ...
                <div class="col-lg-4 col-md-6 m-md-auto col-sm-8 col-10 m-auto">
                    <div class="blog-post">
                        <div class="post-thumb">
                            <a href="news-single.html">
                                <img src="{{ asset('images/news/post-thumb-three.jpg') }}" alt="post-image"
                                    class="img-fluid">
                            </a>
                        </div>
                        <div class="post-content">
